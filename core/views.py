    ...
    def post(self, *args, **kwargs):
        ...
        try:
            ...
            if form.is_valid():
                ...
                messages.warning(
                    self.request, "Form is not valid. Please correct the errors.")
                return redirect('core:checkout')
    ...
    def post(self, *args, **kwargs):
        ...
        if form.is_valid():
            try:
                ...
                # Retrieve the coupon instance based on the provided code
        ...
        messages.error(self.request, "Failed to add coupon. Please try again.")
        return redirect("core:checkout")
